...
import { Drawer, DrawerBody, DrawerFooter, DrawerHeader, DrawerOverlay, DrawerContent, Button, VStack } from '@chakra-ui/react';
  ...
  return (
    <>
      ...
      <LocaleContext.Provider value={data.locales}>
        <Drawer isOpen={visible} onClose={closeScoreboard} placement={data.drawerSide} blockScrollOnMount={false}>
          <DrawerOverlay />
          <DrawerContent>
            ...
            <DrawerBody>
              <VStack spacing={6}>
                {data.groups && (data.visibleParts === 'both' || data.visibleParts === 'groups') && (
                  <GroupList groups={data.groups} />
                )}

                {data.players && (data.visibleParts === 'both' || data.visibleParts === 'players') && (
            ...
            <DrawerFooter justifyContent="center">
              <Footer playerCount={data.playerCount} maxPlayers={data.maxPlayers} serverId={data.serverId} />
            </DrawerFooter>
          </DrawerContent>
        </Drawer>
